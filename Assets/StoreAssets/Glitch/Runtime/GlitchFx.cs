...
namespace VolFx
{
    [DisallowMultipleRendererFeature("GlitchFx")]
    public class GlitchFx : ScriptableRendererFeature
    {
        ...
        public class PassExecution : ScriptableRenderPass
        {
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                _initApi._cmd = cmd;
                _callApi._cmd = cmd;
                _callApi._cam = cameraData.camera;
